...
namespace app\components\telegrambot\Exceptions;

use app\components\telegrambot\TelegramResponse;

/**
 * Class TelegramResponseException
 * @package app\components\telegrambot\Exceptions
 */
class TelegramResponseException extends TelegramSDKException
{
    /** @var \app\components\telegrambot\TelegramResponse The response that threw the exception.*/
    protected $response;
     ...
     * @param \app\components\telegrambot\TelegramResponse $response The response that threw the exception.
     * @param \app\components\telegrambot\Exceptions\TelegramSDKException $previousException The more detailed exception.
     */
